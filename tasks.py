...
def typecheck(c):
    """
    Typecheck ``drillcore-transformations`` with ``mypy``.
    """
...
def performance_profile(c):
    """
    Profile drillcore-transformations performance with ``pyinstrument``.
    """
    print("Profiling drillcore-transformations performance with pyinstrument.")
