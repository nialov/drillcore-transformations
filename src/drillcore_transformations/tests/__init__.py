...
amount_degrees_strategy = floats(0, 360.0)
...
# sample_csv = (
#     Path(__file__).parent / Path("sample_data/Logging_sheet.csv")
# ).absolute()
# sample_csv_result = (
#     Path(__file__).parent / Path("sample_data/Logging_sheet_transformed.csv")
# ).absolute()
