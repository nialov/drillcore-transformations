...
setup(
    ...
    entry_points={
        'console_scripts': [
            'borehole_transformations=borehole_transformations.cli:main',
        ],
    },
    ...
    keywords='borehole_transformations',
    name='borehole_transformations',
    packages=find_packages(include=['borehole_transformations', 'borehole_transformations.*']),
